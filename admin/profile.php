    ...
    <div class="body container">
        ...
        <div class="row typecho-page-main">
            <div class="col-mb-12 col-tb-3">
                <p><a href="https://ifdo.ml" title="<?php _e('在 Gravatar 上修改头像'); ?>"><?php echo '<img class="profile-avatar" src="' . Typecho_Common::gravatarUrl($user->qqnum, 100) . '" alt="' . $user->screenName . '" />'; ?></a></p>
